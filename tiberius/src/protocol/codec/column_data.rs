...
impl<'a> Decode<'a, BytesData<'a, BaseMetaDataColumn>> for ColumnData<'static> {
...
impl<'a> Decode<'a, BytesData<'a, VariableLengthContext>> for ColumnData<'static> {
...
impl<'a> Decode<'a, BytesData<'a, FixedLenType>> for ColumnData<'static> {
...
impl<'a> Decode<'a, BytesData<'a, VariableLengthPrecisionContext>> for ColumnData<'static> {
